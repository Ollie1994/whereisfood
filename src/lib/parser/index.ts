...
// pin. Failing in the direction of the post's own day is the conservative miss: it
// cancels a day the truck was plausibly talking about, and the truck can post again.
//
